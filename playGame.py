...
#Sets x_axis and y_axis values to 0 (they're used to determine what monster the user gets at the end)
x_axis = 0
y_axis = 0

#Boolean values to keep track of what part of the game the user has played
played_hunger = False
